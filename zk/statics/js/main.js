...
function getActivePage() {
  ...
  if (file === 'team.html' || file === 'assistants.html' || path.includes('/zk/expert/')) return 'team';
...
function setupUnifiedLinks() {
  ...
  if (nav) {
    ...
    nav.innerHTML = `
      ...
      ${createNavDropdown('专家团队', link('team.html'), [
        { text: '核心专家', href: link('team.html') },
        { text: '助教成员', href: link('assistants.html') }
      ], active === 'team')}
  ...
  if (footerGrid) {
    footerGrid.innerHTML = `
      ...
      <div><h4>专家团队</h4><a href="${link('team.html')}">核心专家</a><a href="${link('assistants.html')}">助教成员</a></div>
