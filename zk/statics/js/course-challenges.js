(function () {
  const COURSE_CHALLENGES = {
    ...
    'photo-memory-detail.html': {
      title: '结营挑战：让记忆变化看得见',
      intro: '记忆营设置阶段性挑战项目，观察孩子在静定专注、脑内成像、整页摄入、信息提取和学习迁移方面的训练变化。',
      items: [
        ['5秒信息成像挑战', '观察孩子是否能在短时间内把学习信息转化为更清晰的脑内图像，并完成提取反馈。'],
        ['1分钟内容图像记忆挑战', '通过内容图像化处理，观察孩子在快速记忆和语言提取方面的变化。'],
        ['5分钟短文摄入挑战', '围绕约300字短文进行整体摄入、复述或默写反馈，观察信息提取质量。'],
        ['10秒整页摄入挑战', '通过整页摄入训练，观察孩子闭眼后是否能从脑内页面提取部分关键信息。'],
        ['学习迁移挑战', '将训练迁移到真实学习内容中，观察日常学习场景中的应用。']
      ],
    ...
    'camp-detail.html': {
      ...
      items: [
        ...
        ['大篇幅限时阅读反馈', '通过小说、说明文、议论文等大篇幅材料限时阅读，观察孩子面对阅读量时的稳定性。']
      ],
      note: '以上为阅读训练中的阶段观察项目，训练目标是综合提升速度、理解和复述质量；具体表现会因孩子基础、材料难度和练习情况有所差异。'
    },
    'public-class-detail.html': {
      title: '4天自学挑战：让孩子体验“我能自己学”',
      intro: '自主营围绕一套学习材料展开训练，通过方法规则梳理、主动提问、错题复盘和AI辅助验证，帮助孩子体验从读懂材料到阶段反馈的完整闭环。',
      items: [
        ['4天学习材料核心挑战', '围绕一套学习材料完成核心学习任务、概念理解、方法梳理、例题验证和错题复盘。'],
        ['阶段测评反馈挑战', '通过阶段测评观察孩子对核心内容的掌握情况，作为阶段反馈目标，不作为统一承诺结果。'],
        ['核心概念大白话表达', '训练孩子用自己的话说清核心概念、方法规则、条件、结论和思考过程，避免只会背不会用。'],
        ['AI 24小时助教使用', '训练孩子把AI当作学习助教，会提问、会追问，也会验证答案是否可靠。'],
        ['知识全景图挑战', '绘制知识全景图，观察孩子是否真正理解不同内容之间的关系。'],
        ['补习依赖降低观察', '通过自主学习流程和错题复盘，观察孩子是否从“等老师讲”逐步转向“自己先学、再验证”。']
      ],
      note: '以上为自主学习训练中的阶段挑战和测评反馈，不作为统一承诺结果；实际表现会受孩子基础、材料难度、参与状态和练习完成度影响。'
    }
  };
